...
library(lubridate)
library(dplyr)
setwd("C:/Users/Asus/Desktop/Admistracion de la Info/TF_AdmiInfo_Cavero_Morales/TrabajoFinalAdminInfo_Cavero_Morales")
...
```{r}
# 18) Nos muestra todos los datos de la columna, buscando por una fecha especifica de búsqueda.
